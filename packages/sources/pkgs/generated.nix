...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  klipper-screen = {
    ...
    version = "f05cbe9f0b94cdd052d5061bad77272204a8b764";
    src = fetchFromGitHub ({
      owner = "jordanruthe";
      repo = "KlipperScreen";
      rev = "f05cbe9f0b94cdd052d5061bad77272204a8b764";
      fetchSubmodules = false;
      sha256 = "sha256-9J6cmX4NlZ6XbrpATRtXuFH0Ov+eSlAUO/vk1gc1gac=";
    });
    date = "2022-11-10";
  };
  libcamera = {
  ...
  moonraker = {
    pname = "moonraker";
    version = "5a3b1b6e5cb91ca4a30f35c5a599fbae5c2d47b5";
    src = fetchFromGitHub ({
      owner = "Arksine";
      repo = "moonraker";
      rev = "5a3b1b6e5cb91ca4a30f35c5a599fbae5c2d47b5";
      fetchSubmodules = false;
      sha256 = "sha256-W0UFVtvT9kxg7m+7un3Gfcz1B73nWftC9+8nddc4rkU=";
    });
    date = "2022-11-07";
  };
  pam-reattach = {
