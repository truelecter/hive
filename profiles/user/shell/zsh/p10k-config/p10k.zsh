# Generated by Powerlevel10k configuration wizard on 2021-09-03 at 10:54 EEST.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%246Fas '
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_VISUAL_IDENTIFIER_EXPANSION='KUBE'
