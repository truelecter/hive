...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  klipper-happy-hare = {
    ...
    version = "0acb7f17e87db0cd2ff92121ae9359ee3a6c87b0";
    src = fetchFromGitHub {
      owner = "moggieuk";
      repo = "Happy-Hare";
      rev = "0acb7f17e87db0cd2ff92121ae9359ee3a6c87b0";
      fetchSubmodules = false;
      sha256 = "sha256-bS3nJPH67WYZK6Bl1D7mTcb0QY6WcIQfu7KxnNPojRA=";
    };
    date = "2025-01-03";
  };
  klipper-kamp = {
  ...
  klipper-screen = {
    ...
    version = "3d064a3517f33fede2b3092c7fd3e7b5f29513f3";
    src = fetchFromGitHub {
      owner = "jordanruthe";
      repo = "KlipperScreen";
      rev = "3d064a3517f33fede2b3092c7fd3e7b5f29513f3";
      fetchSubmodules = false;
      sha256 = "sha256-0vzcxPSGAr1W9qSxsDiTaksEK+jgyPh/hqzMwDe4a28=";
    };
    date = "2024-12-29";
  };
